            ...
            <div className="content__items">
              <div className="pizza-block">
                <img
                    ...
                    alt="Pizza"
                />
                <h4 className="pizza-block__title">УСТРИЦА BLUE PEARL НОВАЯ ЗЕЛАНДИЯ</h4>
              ...
              <div className="pizza-block">
                <img
                    ...
                    alt="Pizza"
                />
                <h4 className="pizza-block__title">УСТРИЦА МАРОКАННСКАЯ КРУАЗЕ</h4>
                <div className="pizza-block__selector">
                  <ul>
                    <li className="active">опт</li>
                    <li>розница</li>
              ...
              <div className="pizza-block">
                <img
                    ...
                    alt="Pizza"
                />
                <h4 className="pizza-block__title">МОРСКОЙ ГРЕБЕШОК ЖИВОЙ</h4>
                <div className="pizza-block__selector">
                  <ul>
                    <li className="active">опт</li>
                    <li>розница</li>
